...
import { 
  ...
  UnfoldVertical, FoldVertical, FilePlus, Upload
} from 'lucide-react';
                                  ...
                                  <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between gap-2">
                                    ...
                                    <div className="flex gap-2 items-center">
                                      ...
                                      {!isEditing && hasFlashcard && (
                                        <div className="flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-md font-bold tracking-wider bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400" title="Revisão Ativa neste Tópico">
                                          <BrainCircuit className="w-3 h-3"/> Revisão
                                        </div>
                                      )}
